...
## Referans Dosyalar
- [docs/adr/ADR-005](docs/adr/ADR-005-v6-31-kart-mimarisi.md) +
  [docs/curriculum/CUR-004](docs/curriculum/CUR-004-Mufredat.md) — **kanonik müfredat**
  (V6: 7 Temeller + 16 Yetkinlikler + 8 Uzmanlıklar = 31 kart; bölüm/ders henüz
  yok, hepsi 'yakinda'. Yapı dondurma kuralı burada)
